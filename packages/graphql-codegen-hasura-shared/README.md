...
This package contains shared Types and supporting functions for the [graphql-codegen-hasura tools](https://github.com/ahrnee/graphql-codegen-hasura) code generation process
