...
export function injectSharedHelpersPost({
  ...
  if (withClientAndCacheHelpers || withQueries || withInserts || withUpdates || withSubscriptions) {
    ...
    if (withClientAndCacheHelpers) fragmentHelperObject += `      clientWriteFragmentInsertById: clientWriteFragment${fragmentNamePascalCase}InsertById,\n`;
    if (withClientAndCacheHelpers) fragmentHelperObject += `      cacheWriteFragmentInsertById: cacheWriteFragment${fragmentNamePascalCase}InsertById,\n`;
